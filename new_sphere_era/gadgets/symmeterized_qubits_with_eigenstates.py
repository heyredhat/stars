...
print("usage: python symmeterized_qubits_with_eigenstates.py *n-qubits*")
print("a vs. d : +/- sigma x")
print("s vs. w : +/- sigma z")
print("z vs. x : +/- sigma y")
print("qubit # to switch active qubit; 0 to start")
print("p to get new total state")
print("t to toggle time evolution")
n_qubits = 3
