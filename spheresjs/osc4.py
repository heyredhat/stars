...
Xmomentum = vp.arrow(color=vp.color.red)
Ymomentum = vp.arrow(color=vp.color.red)
Zmomentum = vp.arrow(color=vp.color.red)

vp.scene.bind('keydown', sphere.keyboard)  

arrow = vp.arrow(pos=vp.vector(0,0,0), color=vp.color.green)
